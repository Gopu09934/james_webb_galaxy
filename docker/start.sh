...
CHAIN+="[base]drawbox=x=0:y=0:w=400:h=640:color=black@0.55:t=fill[p1];"
CHAIN+="[p1]drawbox=x=0:y=0:w=400:h=8:color=${GOLD}@0.9:t=fill[p2];"
CHAIN+="[p2]drawbox=x=396:y=0:w=4:h=640:color=${GOLD}@0.7:t=fill[p3];"
